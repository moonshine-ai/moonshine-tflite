...
class ModelT(object):
    ...
    def __init__(
        ...
        self.operatorCodes = operatorCodes  # type: Optional[List[tflite.OperatorCode.OperatorCodeT]]
        self.subgraphs = subgraphs  # type: Optional[List[tflite.SubGraph.SubGraphT]]
        self.description = description  # type: Optional[str]
        self.buffers = buffers  # type: Optional[List[tflite.Buffer.BufferT]]
        self.metadataBuffer = metadataBuffer  # type: Optional[List[int]]
        self.metadata = metadata  # type: Optional[List[tflite.Metadata.MetadataT]]
        self.signatureDefs = signatureDefs  # type: Optional[List[tflite.SignatureDef.SignatureDefT]]
