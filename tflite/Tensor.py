...
class TensorT(object):
    ...
    def __init__(
        ...
        self.quantization = quantization  # type: Optional[tflite.QuantizationParameters.QuantizationParametersT]
        self.isVariable = isVariable  # type: bool
        self.sparsity = sparsity  # type: Optional[tflite.SparsityParameters.SparsityParametersT]
        self.shapeSignature = shapeSignature  # type: Optional[List[int]]
        self.hasRank = hasRank  # type: bool
        self.variantTensors = variantTensors  # type: Optional[List[tflite.VariantSubType.VariantSubTypeT]]
