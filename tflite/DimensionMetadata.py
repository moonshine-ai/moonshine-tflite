...
class DimensionMetadataT(object):
    ...
    def __init__(
        ...
        self.arraySegments = arraySegments  # type: Union[None, 'tflite.Int32Vector.Int32VectorT', 'tflite.Uint16Vector.Uint16VectorT', 'tflite.Uint8Vector.Uint8VectorT']
        self.arrayIndicesType = arrayIndicesType  # type: int
        self.arrayIndices = arrayIndices  # type: Union[None, 'tflite.Int32Vector.Int32VectorT', 'tflite.Uint16Vector.Uint16VectorT', 'tflite.Uint8Vector.Uint8VectorT']
